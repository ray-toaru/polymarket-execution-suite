# Validation Report — v0.27.2 controlled real-funds canary source-candidate

## Current Conclusion

v0.27.2 is being prepared as a controlled real-funds canary source-candidate.
...
```text
dist/polymarket-execution-suite-v0.27.2.zip
dist/polymarket-execution-suite-v0.27.2.zip.sha256
dist/polymarket-execution-suite-v0.27.2.zip.evidence.json
```
...
`scripts/check_dist_index.py dist 0.27.2` passes and
...
canonical evidence manifest for v0.27.2 and the v0.27 artifact sidecars exist,
...
.venv/bin/python scripts/check_dist_index.py dist 0.27.2
