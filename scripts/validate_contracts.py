...
VALIDATORS = [
    ...
    ValidatorSpec("sql_idempotency", "surface", "token", False, validate_sql_idempotency),
    ValidatorSpec("rust_deny_unknown_fields", "surface", "mixed", False, validate_rust_deny_unknown_fields),
    ValidatorSpec("v04_source_landings", "executor", "token", False, validate_v04_source_landings),
    ValidatorSpec("v07_source_landings", "executor", "token", False, validate_v07_source_landings),
    ValidatorSpec("v08_dependency_and_sdk_policy", "executor", "mixed", False, validate_v08_dependency_and_sdk_policy),
    ValidatorSpec("v09_official_adapter_boundary", "executor", "token", False, validate_v09_official_adapter_boundary),
    ...
    ValidatorSpec("store_and_backend_structure", "executor", "token", False, validate_store_and_backend_structure),
