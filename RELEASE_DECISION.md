...
2026-06-30 against an isolated PostgreSQL 16 test cluster. Credentialed
non-trading smoke and sign-only dry-run were not refreshed in the current local
run because `PMX_RUN_AUTHENTICATED_NON_TRADING_SMOKE` and
...
and historical 2026-05-23 credentialed non-trading evidence remain prior
context only.
